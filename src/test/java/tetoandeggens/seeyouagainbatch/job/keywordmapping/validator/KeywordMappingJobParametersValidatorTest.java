...
@DisplayName("KeywordMappingJobParametersValidator 단위 테스트")
class KeywordMappingJobParametersValidatorTest {

	private KeywordMappingJobParametersValidator validator;

	@BeforeEach
	void setUp() {
		validator = new KeywordMappingJobParametersValidator();
	}
