...
@DisplayName("AnimalDataLoadJobParametersValidator 단위 테스트")
class AnimalDataLoadJobParametersValidatorTest {

    private AnimalDataLoadJobParametersValidator validator;

    @BeforeEach
    void setUp() {
        validator = new AnimalDataLoadJobParametersValidator();
    }
