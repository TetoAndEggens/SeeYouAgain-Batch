package tetoandeggens.seeyouagainbatch.common.reader.options;
...
public class QuerydslNoOffsetNumberOptions<T, N extends Number & Comparable<?>> extends QuerydslNoOffsetOptions<T> {
	...
	public static <T, N extends Number & Comparable<?>> QuerydslNoOffsetNumberOptions<T, N> of(
		@Nonnull NumberPath<N> field, @Nonnull Expression expression) {
		return new QuerydslNoOffsetNumberOptions<>(field, expression);
	}

	public static <T, N extends Number & Comparable<?>> QuerydslNoOffsetNumberOptions<T, N> of(
		@Nonnull NumberPath<N> field, @Nonnull Expression expression, String idName) {
